  ...
  validate.validators = {
    ...
    presence: function(value, options) {
      ...
      if (options.allowEmpty !== false ? !v.isDefined(value) : v.isEmpty(value)) {
        return v.lang("presence.message", options.message || this.message);
      }
    },
    length: function(value, options) {
      ...
      if(!v.isNumber(length)) {
        return v.lang("length.message", options.message || this.notValid);
      }
    ...
    numericality: function(value, options, attribute, attributes, globalOptions) {
      ...
      if (v.isString(value) && options.strict) {
        ...
        if (!(new RegExp(pattern).test(value))) {
          return v.lang(
            ...
            options.notValidStrict || options.message || this.notValidStrict || this.message
          );
        }
      }
      ...
      for (name in checks) {
        ...
        if (v.isNumber(count) && !checks[name](value, count)) {
          ...
          var msg = v.lang(
            "numericality." + key,
            options[key] || this[key] || this.message || v.lang("numericality.check")
          );
      ...
      if (options.odd && value % 2 !== 1) {
        errors.push(v.lang("numericality.notOdd", options.notOdd || this.notOdd || this.message));
      }
      if (options.even && value % 2 !== 0) {
        errors.push(v.lang("numericality.notEven", options.notEven || this.notEven || this.message));
      }
    ...
    format: function(value, options) {
      ...
      var message = v.lang("format.message", options.message || this.message)
    ...
    inclusion: function(value, options) {
      ...
      var message = v.lang("inclusion.message", options.message || this.message);
    ...
    exclusion: function(value, options) {
      ...
      var message = v.lang("exclusion.message", options.message || this.message);
    ...
    email: v.extend(function(value, options) {
      options = v.extend({}, this.options, options);
      var message = v.lang("email.message", options.message || this.message);
      // Empty values are fine
      if (!v.isDefined(value)) {
        return;
      }
    ...
    equality: function(value, options, attribute, attributes, globalOptions) {
      ...
      options = v.extend({}, this.options, options);
      var message = v.lang("equality.message", options.message || this.message);
    ...
    url: function(value, options) {
      ...
      var message = v.lang("url.message", options.message || this.message)
  ...
  validate.setLocale = function (locale, message) {
    if (!message && v.isObject(locale)) {
      for (var localeKey in locale) {
        validate.locales[localeKey] = v.extend({}, v.locales.en, locale[localeKey]);
      }
    } else {
      validate.locales[locale] = v.extend({}, v.locales.en, message);
    }
  };
